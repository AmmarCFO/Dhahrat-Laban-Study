          ...
          <div className="flex items-center gap-3">
             <button 
              ...
              <button 
                ...
                className="px-4 py-2 text-sm font-bold text-[#4A2C5A] bg-white border border-[#4A2C5A]/10 rounded-lg hover:bg-[#F5F5F7] hover:border-[#4A2C5A]/30 transition-all shadow-sm font-cairo"
              >
                المنافسين
              </button>
          </div>
